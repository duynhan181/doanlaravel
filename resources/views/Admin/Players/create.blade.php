                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Create New Players</h1>
                                    </div>
                                    <form method="POST" action="{{ route('players.store') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-player @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}"
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-player @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" 
